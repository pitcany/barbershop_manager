"""
Celery task: appointment reminders (hourly).

Worker entry point for run_reminder_job_for_all_shops.
...
@celery_app.task(
    bind=True,
    name="tasks.reminders.run_reminders_task",
    max_retries=3,
    default_retry_delay=300,
)
def run_reminders_task(self):
    """Celery task: run appointment reminders for all shops."""
