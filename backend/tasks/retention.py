"""
Celery task: retention re-engagement sweep (daily).

Worker entry point for run_retention_for_all_shops.
...
@celery_app.task(
    bind=True,
    name="tasks.retention.run_retention_task",
    max_retries=3,
    default_retry_delay=300,
)
def run_retention_task(self):
    """Celery task: run retention sweep for all shops."""
